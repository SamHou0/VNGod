...
English | [在线中文文档](https://vngod.samhou.moe)
...
> [!NOTE]
> This app is designed for Chinese users and use Chinese data source like *Bangumi*, but there **IS** an English UI. However, translating docs to English require a lot of effort, so English docs is **NOT** available now. If you're interested in translating the docs website to English, please submit a Pull Request.

## Features

- Organize your novels
- Automatically match entries in:
  - [Bangumi](https://bgm.tv)
  - [vndb](https://vndb.org)
- Open folder, game and entry page quickly
- Record your playing time
- Sync your saves and scanned files to WebDAV
